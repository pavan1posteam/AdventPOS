...
namespace AdventPos
{
    class AdventPos_Flatfile
    {
        string BaseUrl = ConfigurationManager.AppSettings.Get("BaseDirectory");

        public AdventPos_Flatfile(int StoreId, decimal tax, List<UPC> upcs)
        {
            try
            {
                            ...
                            try
                            {
                                ...
                                foreach (DataRow dr in dt.Rows)
                                {
                                    ...
                                    if (StoreId == 11196)
                                    {
                                        ...
                                        var y = dr["TOTALQTY_MULTI"].ToString();
    ...
    public class adventProductsModel
    {
